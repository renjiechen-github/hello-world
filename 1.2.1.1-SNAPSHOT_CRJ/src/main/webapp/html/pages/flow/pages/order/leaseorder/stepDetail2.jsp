...
<section class="panel">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<div class="form-group col-sm-12" id="changeDiv3" style="text-align: center;">
				...
				<button class="btn btn-info" onclick="stepDetail3.save(2);" type="button">接单</button>
			</div>
			<div class="form-group col-sm-12" id="changeDiv4"
				style="text-align: center;">
				<button class="btn btn-info" id="back" type="button">返回</button>
				<button class="btn btn-info" onclick="stepDetail3.save(3);" type="button">指派</button>
			</div>
		</div>
	</div>
	</section>
	...
	<script type="text/javascript" src="/html/pages/flow/js/order/miLeaseorder/stepDetail2.js"></script>
</c:if>
...
<c:if test="${isMobile eq '0'}">
	...
	<script type="text/javascript" src="/html/pages/flow/js/order/workorder/stepDetail2.js"></script>
	</c:if>
</body>
</html>
