...
<section class="panel">
	...
	<script type="text/javascript" src="/html/pages/flow/js/order/miWriteorder/stepDetail2.js"></script>
</c:if>
<c:if test="${isMobile eq '0'}">
	...
	<script type="text/javascript" src="/html/pages/flow/js/order/writeorder/stepDetail2.js"></script>
	</c:if>
</body>
</html>
