...
<body>
	...
	<c:if test="${isMobile eq '1'}">
		...
		<script type="text/javascript" src="/html/pages/flow/js/order/miRankorder/stepDetail4.js"></script>
	</c:if>
	<c:if test="${isMobile eq '0'}">
		...
		<script type="text/javascript"
			src="/html/pages/flow/js/order/rankorder/stepDetail4.js"></script>
