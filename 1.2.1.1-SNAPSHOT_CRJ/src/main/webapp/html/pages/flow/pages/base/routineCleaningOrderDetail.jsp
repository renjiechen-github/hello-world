					...
					<div class="panel-body">
						<form class="form-horizontal adminex-form" role="form" id="takOrderForm">
							...
							<div class="text-center">
								<button class="btn btn-info hidden" id="confirmReassignOrderBtn" onclick="jsRoutineCleaningOrderDetail.assignOrder();" type="button">指派</button>
							</div>
						</form>
					</div>
				</div>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<form class="form-horizontal adminex-form" role="form" id="butlerGetHomeForm">
							...
							<div class="text-center">
								<button class="btn btn-info hidden" id="butlerGetHomeBtn" onclick="jsRoutineCleaningOrderDetail.takeOrder()" type="button">接单</button>
								<button class="btn btn-info hidden" id="butlerReassign" onclick="jsRoutineCleaningOrderDetail.butlerReassign();" type="button">指派</button>
								<button class="btn btn-info hidden" id="butlerAgainReassign" onclick="jsRoutineCleaningOrderDetail.butlerAgainReassign();" type="button">重新派单</button>
								<button class="btn btn-info hidden" id="butlerCancelReassign" onclick="jsRoutineCleaningOrderDetail.butlerCancelReassign();" type="button">返回</button>
							</div>
						</form>
					</div>
				</div>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<form class="form-horizontal adminex-form" role="form" id="butlerExecuteForm">
							...
							<div class="form-group col-md-12 col-xs-12">
								<label class="col-md-2 col-xs-4 control-label js-customer-serv-upurl"></label>
								<div class="col-md-8 col-xs-12">
                  <c:choose>
                    <c:when test="${isMobile eq 'Y'}">
                      <div class="upload">
                        <a href="javascript:;" class="file" id="upurl-1" onclick="jsRoutineCleaningOrderDetail.uploadhousePicture()"> 选择照片上传 </a>
                    ...
                    <c:otherwise>
                      ...
                      <div class="row"></div>
							...
							<div class="text-center">
								<button id="rentalAccountBtn" class="btn btn-info hidden" onclick="jsRoutineCleaningOrderDetail.processOrder('N');" type="button">保存</button>
								<button id="rentalAccountPassBtn" class="btn btn-info hidden" onclick="jsRoutineCleaningOrderDetail.processOrder('Y');" type="button">提交</button>
								<button class="btn btn-info hidden" id="againAssignOrder" onclick="jsRoutineCleaningOrderDetail.againAssignOrder()" type="button">重新指派</button>
								<button class="btn btn-info hidden" id="againAssignOrderBtn" onclick="jsRoutineCleaningOrderDetail.againAssignOrderBtn()" type="button">提交</button>
								<button class="btn btn-info hidden" id="againAssignOrderCancelBtn" onclick="jsRoutineCleaningOrderDetail.againAssignOrderCancelBtn()" type="button">取消</button>								
							</div>
						</form>
					</div>
				</div>
...
<%-- 			<div class="tab-pane fade" id="CUSTOMER_SERV_VISIT">
				<div class="panel panel-default">
                  ...
                  <c:choose>
                    <c:when test="${isMobile eq 'Y'}">
                      <div class="upload">
                        <a href="javascript:;" class="file" id="upurl-2" onclick="jsRoutineCleaningOrderDetail.uploadReback()"> 选择照片上传 </a>
                    ...
                    <c:otherwise>
                      ...
                      <div class="row"></div>
							...
							<div class="text-center">
								<button class="btn btn-info hidden" id="passInStaffReview" onclick="jsRoutineCleaningOrderDetail.passInStaffReview()" type="button">通过</button>
								<button class="btn btn-info hidden" id="reassign" onclick="jsRoutineCleaningOrderDetail.reassign();" type="button">指派</button>
								<button class="btn btn-info hidden" id="staffTace" onclick="jsRoutineCleaningOrderDetail.staffTace();" type="button">订单追踪</button>
								<button class="btn btn-info hidden" id="reassignOrderBtn" onclick="jsRoutineCleaningOrderDetail.reassignOrderInStaffReview();" type="button">重新派单</button>
								<button class="btn btn-info hidden" id="cancelReassignOrderBtn" onclick="jsRoutineCleaningOrderDetail.cancelReassignOrder();" type="button">返回</button>
							</div>
						</form>
					</div>
				</div>
...
<script type="text/javascript" src="/html/pages/flow/js/order/leaseorder/routineCleaningOrderDetail.js"></script>
</html>
