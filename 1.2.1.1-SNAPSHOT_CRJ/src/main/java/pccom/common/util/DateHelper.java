...
public class DateHelper extends BaseLogger
{
	public static final Logger logger = org.slf4j.LoggerFactory.getLogger(DateHelper.class);
     ...
     */  
    public static String checkOption(int option, String _date) {  
        ...
        if (option<0) {  
            ...
            // 时间加一天  
            cl.add(Calendar.DAY_OF_YEAR, option);  
        } else {  
            // do nothing  
        }  
        date = cl.getTime();  
	 ...
	 * @return
	 */
	public static String getDay(String pattern,int js)
	{
		Calendar cal = Calendar.getInstance();
		cal.add(Calendar.DAY_OF_MONTH, js);
		SimpleDateFormat format = new SimpleDateFormat(pattern);
		return format.format(cal.getTime());
	}
	...
	public static int getWeekOfMonth(Date date)
	{
		...
		else
		{
			...
			//logger.debug("XXX："+format.format(c1.getTime()));
			Date firstDateOfLastMonth=getFirstDateOfMonth(c1.getTime());
			
			//logger.debug("计算月第一天："+format.format(firstDateOfLastMonth));
			fisrtMondayOfMonth=getFirstMondayOfMonth(firstDateOfLastMonth);
		}
		//logger.debug("计算月第一个星期一："+format.format(fisrtMondayOfMonth));
	...
	{  
//		logger.debug(getMonthDay(-1,"yyyyMMdd","20100228")); 
//		logger.debug(getMonthDay(-1,"yyyyMMdd","20100131"));
//		logger.debug(getMonthDay(-1,"yyyyMMdd","20100331"));
//		logger.debug(getMonthDay(-1,"yyyyMMdd","20100430"));
//		logger.debug(getMonthDay(-1,"yyyyMMdd","20100402"));
//		logger.debug(getMonthDay(-1,"yyyyMMdd","20100217"));
//		logger.debug(getDay("yyyy-MM-dd",-30));
		GregorianCalendar gc =new GregorianCalendar();
		gc.setTime(new Date());
		gc.add(1,2);
		logger.debug(new SimpleDateFormat("yyyy-MM-dd").format(gc.getTime()));
	}
	 ...
	 * @return
	 */
	public static String addMonthDate(Date date,int num){
		GregorianCalendar gc =new GregorianCalendar();
		gc.setTime(date);
		gc.add(2,num);
