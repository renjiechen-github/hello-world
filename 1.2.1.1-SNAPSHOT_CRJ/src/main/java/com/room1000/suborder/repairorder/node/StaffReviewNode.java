...
//    }
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        RepairOrderDto repairOrderDto = (RepairOrderDto) delegateTask.getVariable(ActivitiVariableDef.REPAIR_ORDER);
        ...
        repairOrderDto.setAssignedDealerRoleId(SystemRoleDef.ROLE_CUSTOMER_SERVICE);
        repairOrderDto.setState(SubOrderStateDef.STAFF_REVIEW);
        ...
        workOrderDto.setSubAssignedDealerRoleId(repairOrderDto.getAssignedDealerRoleId());
