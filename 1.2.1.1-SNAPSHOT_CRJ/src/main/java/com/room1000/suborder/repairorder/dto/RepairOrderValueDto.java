...
/**
 *
 * Description: repair_order_value实体
 *
 ...
 * @since v1.0
 */
public class RepairOrderValueDto extends SubOrderValueDto implements Serializable {
    /**
     * id 主键
     */
    private Long id;
    ...
    public String toString() {
        ...
        builder.append("RepairOrderValueDto [id=");
        builder.append(id);
