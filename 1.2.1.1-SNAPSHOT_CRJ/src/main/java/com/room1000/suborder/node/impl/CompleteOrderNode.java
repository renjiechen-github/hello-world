 ...
 * @since v1.0
 */
@Component("CompleteOrderNode")
public class CompleteOrderNode implements IProcessAction {
    ...
    private void doProcess(Map<String, Object> variables) {
        ...
        ICompleteOrderNodeProcess process = SubOrderNodeFactory.getCompleteOrderNode(workOrderDto.getType());
