 ...
 * @since v1.0
 */
@Component("Apply2PayNode")
public class Apply2PayNode implements IProcessAction {
    ...
    private void doProcess(Map<String, Object> variables) {
        ...
        IApply2PayNodeProcess process = SubOrderNodeFactory.getApply2PayNode(workOrderDto.getType());
