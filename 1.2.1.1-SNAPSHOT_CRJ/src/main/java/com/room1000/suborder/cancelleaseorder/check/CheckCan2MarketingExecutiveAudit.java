 ...
 */
@Deprecated
public class CheckCan2MarketingExecutiveAudit implements IProcessExpression {
    ...
    public boolean getResult(Map<String, Object> variables) {
        ...
        if (cancelLeaseOrderValueDto != null && BooleanFlagDef.BOOLEAN_TRUE.equals(cancelLeaseOrderValueDto.getTextInput())) {
            return true;
        }
        return false;
    }
