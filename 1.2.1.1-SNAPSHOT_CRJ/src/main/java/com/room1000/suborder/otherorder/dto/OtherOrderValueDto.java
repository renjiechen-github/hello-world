package com.room1000.suborder.otherorder.dto;
...
/**
 *
 * Description: other_order_value实体
 *
 ...
 * @since v1.0
 */
public class OtherOrderValueDto extends SubOrderValueDto implements Serializable {
    /**
     * id 主键
     */
    private Long id;
    ...
    public String toString() {
        ...
        builder.append("OtherOrderValueDto [id=");
        builder.append(id);
