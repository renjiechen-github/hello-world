...
/**
 *
 * Description: complaint_order_value实体
 *
 ...
 * @since v1.0
 */
public class ComplaintOrderValueDto extends SubOrderValueDto implements Serializable {
    ...
    public String toString() {
        ...
        builder.append("ComplaintOrderValueDto [id=");
        builder.append(id);
