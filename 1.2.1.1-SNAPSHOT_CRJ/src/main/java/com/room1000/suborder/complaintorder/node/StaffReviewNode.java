...
//    }
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        ComplaintOrderDto complaintOrderDto = (ComplaintOrderDto) delegateTask.getVariable(ActivitiVariableDef.COMPLAINT_ORDER);
        ...
        complaintOrderDto.setState(SubOrderStateDef.STAFF_REVIEW);
