...
/**
 *
 * Description: routine_cleaning_order_his实体
 *
 * Created on 2017年03月12日
 * @author jinyanan
 * @version 1.0
 * @since v1.0
 */
public class RoutineCleaningOrderHisDto implements Serializable {
    /**
     * priority 优先级
     */
    ...
    public String toString() {
        ...
        builder.append("RoutineCleaningOrderHisDto [priority=");
