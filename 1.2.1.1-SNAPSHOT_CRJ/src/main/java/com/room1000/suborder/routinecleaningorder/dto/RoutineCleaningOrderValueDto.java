package com.room1000.suborder.routinecleaningorder.dto;
...
/**
 *
 * Description: routine_cleaning_order_value实体
 *
 ...
 * @since v1.0
 */
public class RoutineCleaningOrderValueDto extends SubOrderValueDto implements Serializable {
    /**
     * id 主键
     */
    private Long id;
    ...
    public String toString() {
        ...
        builder.append("RoutineCleaningOrderValueDto [id=");
        builder.append(id);
