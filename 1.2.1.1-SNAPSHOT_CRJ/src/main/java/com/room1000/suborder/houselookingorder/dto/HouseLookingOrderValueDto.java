...
/**
 *
 * Description: house_looking_order_value实体
 *
 ...
 * @since v1.0
 */
public class HouseLookingOrderValueDto extends SubOrderValueDto implements Serializable {
    /**
     * id 主键
     */
    private Long id;
    ...
    public String toString() {
        ...
        builder.append("HouseLookingOrderValueDto [id=");
        builder.append(id);
