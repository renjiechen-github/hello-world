package com.room1000.suborder.livingproblemorder.dto;
...
/**
 *
 * Description: living_problem_order实体
 *
 ...
 * @since v1.0
 */
public class LivingProblemOrderDto implements Serializable {
    /**
     * id 主键
     */
    private Long id;
     ...
     * subOrderValueList
     */
    private List<LivingProblemOrderValueDto> subOrderValueList;
    ...
    public List<LivingProblemOrderValueDto> getSubOrderValueList() {
        return subOrderValueList;
    }

    public void setSubOrderValueList(List<LivingProblemOrderValueDto> subOrderValueList) {
    ...
    public String toString() {
        ...
        builder.append("LivingProblemOrderDto [id=");
        builder.append(id);
        builder.append(", code=");
        builder.append(code);
