...
/**
 *
 * Description: living_problem_order_value实体
 *
 ...
 * @since v1.0
 */
public class LivingProblemOrderValueDto extends SubOrderValueDto implements Serializable {
    /**
     * id 主键
     */
    private Long id;
    ...
    public String toString() {
        ...
        builder.append("LivingProblemOrderValueDto [id=");
        builder.append(id);
