...
public class ExclusiveGatewayActivityBehaviorExt extends ExclusiveGatewayActivityBehavior {
    ...
    /** logger */
    private static Logger logger = LoggerFactory.getLogger(ExclusiveGatewayActivityBehaviorExt.class);
    ...
    private boolean getInstanceResult(Condition condition, Map<String, Object> variables) {
        try {
            ...
            if (conditionStr == null || conditionStr.length() == 0 || !conditionStr.startsWith("com")) {
                return false;
            }
