...
public class TeamRelation
{
	...
	private int areaId;
	/** 人员可操作性标识 **/
	private int memIfOp = 0;
	
	public int getMemIfOp()
	{
		return memIfOp;
	}

	public void setMemIfOp(int memIfOp)
	{
		this.memIfOp = memIfOp;
	}
	...
	public String toString()
	{
		return "TeamRelation [id=" + id + ", teamId=" + teamId + ", userId=" + userId + ", memberId=" + memberId + ", newMemberId=" + newMemberId + ", memberName=" + memberName
				+ ", memCnt=" + memCnt + ", teamLevel=" + teamLevel + ", topTeamId=" + topTeamId + ", ifCharge=" + ifCharge + ", areaId=" + areaId + "],memIfOp=["+memIfOp+"]";
	}
