...
<body>
	...
	<c:if test="${isMobile eq '0'}">
		...
		<ul class="nav nav-tabs" role="tablist" id="myTabs">
			<li role="presentation" class="active"><a href="#NEW_ORDER_2_DEAL" aria-controls="NEW_ORDER_2_DEAL" role="tab" data-toggle="tab">新已处理任务 </a></li>
			<li role="presentation"><a href="#OTHER_2_DEAL" aria-controls="OTHER_2_DEAL" role="tab" data-toggle="tab">普通已处理任务 </a></li>
		</ul>
		</header> </section>
		...
		<div id="myTabContent" class="tab-content">
			...
			<div class="tab-pane fade in active" id="NEW_ORDER_2_DEAL">
				<section class="panel"> <section class="panel panel-info panel-seach">
				<div class="panel-body">
					<form class="form-inline" role="form">
						<div class="form-group">
							<label for="exampleInputEmail2">订单类型:</label> <select class="form-control" id="order_type" name="order_type">
								<option value="">请选择...</option>
							</select>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail2">订单状态:</label> <select class="form-control" id="order_state" name="order_state">
								<option value="">请选择...</option>
						...
						<div class="form-group">
							<label for="exampleInputEmail2">模糊查询:</label> <input type="text" class="form-control suitable" id="keyword" placeholder="用户名、用户手机、订单编号">
						</div>
			...
			<script type="text/javascript" src="/html/pages/flow/js/base/myYetOrder.js"></script>
		</div>
		<script type="text/javascript" src="/html/pages/flow/js/base/yetDisposeTask.js"></script>
	</c:if>
</body>
</html>
