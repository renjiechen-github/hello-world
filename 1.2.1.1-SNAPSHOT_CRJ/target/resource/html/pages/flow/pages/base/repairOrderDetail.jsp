		...
		<div class="panel-body">
			<form class="form-horizontal adminex-form" role="form">
				...
				<div class="form-group col-md-12 col-xs-12">
					...
					<div class="col-md-4 col-xs-12">
						<p class="form-control-static js-type-name"></p>
					</div>
				</div>
				<div class="form-group col-md-12 col-xs-12">
					...
					<div class="col-md-8 col-xs-12">
						<c:choose>
							<c:when test="${isMobile eq 'Y'}">
								<div class="upload">
									<!--<a href="javascript:;" class="file" id="upurl-3" onclick="jsRepairOrderDetail.uploadNbrAttachment()"> 选择照片上传 </a>-->
					...
					<div class="panel-body">
						<form class="form-horizontal adminex-form" role="form" id="takOrderForm">
							...
							<div class="form-group col-md-12 col-xs-12">
								...
								<div class="col-md-8 col-xs-12">
									<textarea onblur="this.value=this.value.replace(/[^\u0020-\u007E\u00A0-\u00BE\u2E80-\uA4CF\uF900-\uFAFF\uFE30-\uFE4F\uFF00-\uFFEF\u0080-\u009F\u2000-\u201f]/g,'')" rows="6" readonly="readonly" class="form-control js-comments-textarea" placeholder="请填写信息"></textarea>
								</div>
							</div>
							<div class="text-center">
								<button class="btn btn-info hidden" id="confirmReassignOrderBtn" onclick="jsRepairOrderDetail.assignOrder();" type="button">指派</button>
							</div>
						</form>
					</div>
				</div>
					...
					<div class="panel-body">
						<form class="form-horizontal adminex-form" role="form" id="butlerGetHomeForm">
							...
							<div class="form-group col-md-12 col-xs-12">
								...
								<div class="col-md-8 col-xs-12">
									<textarea onblur="this.value=this.value.replace(/[^\u0020-\u007E\u00A0-\u00BE\u2E80-\uA4CF\uF900-\uFAFF\uFE30-\uFE4F\uFF00-\uFFEF\u0080-\u009F\u2000-\u201f]/g,'')" rows="6" readonly="readonly" datatype="Require" msg="请填写信息" class="form-control js-house-inspection-comments-textarea"></textarea>
								</div>
								<div class="col-md-2"></div>
							</div>
							<div class="text-center">
								<button class="btn btn-info hidden" id="butlerGetHomeBtn" onclick="jsRepairOrderDetail.takeOrder()" type="button">接单</button>
								<button class="btn btn-info hidden" id="butlerReassign" onclick="jsRepairOrderDetail.butlerReassign();" type="button">指派</button>
								<button class="btn btn-info hidden" id="butlerAgainReassign" onclick="jsRepairOrderDetail.butlerAgainReassign();" type="button">重新派单</button>
								<button class="btn btn-info hidden" id="butlerCancelReassign" onclick="jsRepairOrderDetail.butlerCancelReassign();" type="button">返回</button>
							</div>
						</form>
					</div>
				</div>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<form class="form-horizontal adminex-form" role="form" id="butlerExecuteForm">
							...
							<div class="form-group col-md-12 col-xs-12 js-should-cost-div">
								<label class="col-md-2 col-xs-12 control-label">待付金额</label>
								<div class="col-md-8 col-xs-12">
									<input maxlength="11" class="form-control js-should-cost" value="" disabled="disabled" />
								</div>
								<div class="col-md-2"></div>
							</div>
							<div class="form-group col-md-12 col-xs-12">
								<label class="col-md-2 col-xs-12 control-label">已付金额</label>
								<div class="col-md-8 col-xs-12">
									<p class="form-control-static js-already-cost"></p>
								</div>
								<div class="col-md-2"></div>
							</div>
							<div class="form-group col-md-12 col-xs-12">
								...
								<div class="col-md-8 col-xs-12">
									<c:choose>
										<c:when test="${isMobile eq 'Y'}">
											<div class="upload">
												<a href="javascript:;" class="file" id="upurl-1" onclick="jsRepairOrderDetail.uploadhousePicture()"> 选择照片上传 </a>
							...
							<div class="form-group col-md-12 col-xs-12">
								...
								<div class="col-md-8 col-xs-12">
									<textarea onblur="this.value=this.value.replace(/[^\u0020-\u007E\u00A0-\u00BE\u2E80-\uA4CF\uF900-\uFAFF\uFE30-\uFE4F\uFF00-\uFFEF\u0080-\u009F\u2000-\u201f]/g,'')" rows="6" readonly="readonly" datatype="Require" msg="请填写信息" class="form-control js-rental-account-comments-textarea"></textarea>
								</div>
								<div class="col-md-2"></div>
							</div>
							</div>
							...
							<div class="text-center">
								<button id="rentalAccountBtn" class="btn btn-info hidden" onclick="jsRepairOrderDetail.processOrder('N');" type="button">保存</button>
								<button id="rentalAccountPassBtn" class="btn btn-info hidden" onclick="jsRepairOrderDetail.processOrder('Y');" type="button">提交</button>
								<button class="btn btn-info hidden" id="againAssignOrder" onclick="jsRepairOrderDetail.againAssignOrder()" type="button">重新指派</button>
								<button class="btn btn-info hidden" id="againAssignOrderBtn" onclick="jsRepairOrderDetail.againAssignOrderBtn()" type="button">提交</button>
								<button class="btn btn-info hidden" id="againAssignOrderCancelBtn" onclick="jsRepairOrderDetail.againAssignOrderCancelBtn()" type="button">取消</button>								
							</div>
						</form>
					</div>
				</div>
					...
					<div class="panel-body">
						<form class="form-horizontal adminex-form" role="form" id="marketingExecutiveAuditForm">
							...
							<div class="form-group col-md-12 col-xs-12">
								...
								<div class="col-md-8 col-xs-12">
									<c:choose>
										<c:when test="${isMobile eq 'Y'}">
											<div class="upload">
												<a href="javascript:;" class="file" id="upurl-2" onclick="jsRepairOrderDetail.uploadReback()"> 选择照片上传 </a>
							...
							<div class="form-group col-md-12 col-xs-12">
								...
								<div class="col-md-8 col-xs-12">
									<textarea onblur="this.value=this.value.replace(/[^\u0020-\u007E\u00A0-\u00BE\u2E80-\uA4CF\uF900-\uFAFF\uFE30-\uFE4F\uFF00-\uFFEF\u0080-\u009F\u2000-\u201f]/g,'')" rows="6" readonly="readonly" class="form-control js-marketing-executive-audit-comments-textarea" datatype="Require" msg="请填写信息"></textarea>
								</div>
								<div class="col-md-2"></div>
							</div>
							<div class="text-center">
								<button class="btn btn-info hidden" id="passInStaffReview" onclick="jsRepairOrderDetail.passInStaffReview()" type="button">通过</button>
								<button class="btn btn-info hidden" id="reassign" onclick="jsRepairOrderDetail.reassign();" type="button">指派</button>
								<button class="btn btn-info hidden" id="staffTace" onclick="jsRepairOrderDetail.staffTace();" type="button">订单追踪</button>
								<button class="btn btn-info hidden" id="reassignOrderBtn" onclick="jsRepairOrderDetail.reassignOrderInStaffReview();" type="button">重新派单</button>
								<button class="btn btn-info hidden" id="cancelReassignOrderBtn" onclick="jsRepairOrderDetail.cancelReassignOrder();" type="button">返回</button>
							</div>
						</form>
					</div>
				</div>
...
<script type="text/javascript" src="/html/pages/flow/js/order/leaseorder/repairOrderDetail.js"></script>
</html>
