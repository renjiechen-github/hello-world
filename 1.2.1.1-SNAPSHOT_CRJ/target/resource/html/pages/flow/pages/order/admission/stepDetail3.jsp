...
<html>
  ...
  <body>
   <c:if test="${isMobile eq '1'}">
		...
		<script type="text/javascript" src="/html/pages/flow/js/order/miAdmission/stepDetail3.js"></script>
	</c:if>
	...
	<div class="panel panel-primary">
   	...
   	<script type="text/javascript" src="/html/pages/flow/js/order/admission/stepDetail3.js" ></script>
   	</c:if>
  </body>
</html>
