   ...
   <c:if test="${isMobile eq '1'}">
		...
		<div class="panel panel-primary">
			...
			<div id="changeDiv">
				...
				<div class="upload">
	        		<div class="weui_cell file" id="selectImage1"   onclick="stepDetail4.selectImages('fileUrl5');return false;" >
	        			<a href="">选择文件上传</a> 
	        		</div>
	        		<ul class="ipost-list ui-sortable js_fileList" id="fileUrl5"></ul> 
	        		<input type="hidden" value=""  id="hideurl5"  /> 	        	
			...
			<div id="changeDiv2">
				<form class="form-horizontal" id="form2">
					...
					<div class="form-group ">
					 ...
					 <div class="weui_cells">
			     	<div class="upload">
	        		<div class="weui_cell file" id="selectImage" onclick=" stepDetail4.selectImages('fileUrl2');return false;" >
	        			<a href="">选择文件上传</a> 
	        		</div>
	        		<ul class="ipost-list ui-sortable js_fileList" id="fileUrl2"></ul> 
	        		<input type="hidden" value="${flowDetaiMap.orderList[0].picurls}"  id="hideurl2"  /> 	        	
	        		<input type="hidden" value="" name="picPath" id="picPath"  /> 	        		  
	    		</div>
				</div>
		...
		<script type="text/javascript" src="/html/pages/flow/js/order/miCleanorder/stepDetail3.js"></script>
	</c:if>
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<form class="form-horizontal" id="form2">
					...
					<div class="form-group">
				    <label class="col-sm-2  control-label"><b style="color: red">*</b>保洁类型：</label>
				      <div class="col-sm-8">
					<select dataId="${flowDetaiMap.orderList[0].childtype}" class="form-control" id="childtype3"><option value="">请选择...</option>
					</select>
					  </div>
					  <div class="col-sm-2">
					  </div>
   	...
   	<script type="text/javascript" src="/html/pages/flow/js/order/cleanorder/stepDetail3.js" ></script>
   	</c:if>
  </body>
</html>
