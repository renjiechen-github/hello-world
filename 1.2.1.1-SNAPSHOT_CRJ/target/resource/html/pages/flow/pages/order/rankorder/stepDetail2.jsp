...
<link rel="stylesheet" type="text/css"
	href="/client/css/uploadImage/uploadImage.min.css" />
<link rel="stylesheet" type="text/css"
	...
	<div class="panel-heading">
		...
		<div id="changeDiv2">
			...
			<div class="form-group col-sm-12">
				<label class="col-sm-2  control-label">备注：</label>
				<div class="col-sm-8">
					<textarea rows="6" id="flowremark1" maxlength="256"
						class="form-control"></textarea>
				</div>
				<div class="col-sm-2"></div>
			</div>
		...
		<c:if test="${isMobile eq '1'}">
			...
			<script type="text/javascript"
				src="/html/pages/flow/js/order/miRankorder/stepDetail2.js"></script>
		</c:if>
		<c:if test="${isMobile eq '0'}">
			<script type="text/javascript"
				src="/html/pages/flow/js/order/rankorder/stepDetail2.js"></script>
		</c:if>
</body>
</html>
