	    ...
	    <div class="weui_cells">
  			...
  			<c:choose>
		    	<c:when test="${cfg_step_id == '2'}">
		    		<jsp:include page="/html/pages/flow/pages/order/writeorder/stepDetail2.jsp"></jsp:include>
		    	</c:when>
		    	...
		    	<c:when test="${cfg_step_id == '4'}">
		    		<jsp:include page="/html/pages/flow/pages/order/writeorder/stepDetail4.jsp"></jsp:include>
		    	</c:when>
		    	<c:when test="${cfg_step_id == '5'}">
		    		<jsp:include page="/html/pages/flow/pages/order/rankorder/stepDetail5.jsp"></jsp:include>
		    	</c:when>
		    </c:choose>
  	...
  	<c:choose>
  		<c:when test="${edit==1}">
  			<form class="form-horizontal" id="form2">
				...
				<script type="text/javascript" src="/html/pages/flow/js/order/writeorder/stepDetail.js" ></script>
  			<c:choose>
		    	<c:when test="${cfg_step_id == '2'}">
		    		<jsp:include page="/html/pages/flow/pages/order/writeorder/stepDetail2.jsp"></jsp:include>
		    	</c:when>
		    	<c:when test="${cfg_step_id == '3'}">
		    		<jsp:include page="/html/pages/flow/pages/order/writeorder/stepDetail3.jsp"></jsp:include>
		    	</c:when>
		    	<c:when test="${cfg_step_id == '4'}">
		    		<jsp:include page="/html/pages/flow/pages/order/writeorder/stepDetail4.jsp"></jsp:include>
		    	</c:when>
		    	<c:when test="${cfg_step_id == '5'}">
		    		<jsp:include page="/html/pages/flow/pages/order/writeorder/stepDetail5.jsp"></jsp:include>
		    	</c:when>
		    </c:choose>
  		</c:when>
  		<c:otherwise>
  			<form class="form-horizontal" id="form2">
				...
				<script type="text/javascript" src="/html/pages/flow/js/order/rankorder/stepDetail.js" ></script>
  		</c:otherwise>
  	</c:choose>
  	 	 </c:if>	
  </body>
