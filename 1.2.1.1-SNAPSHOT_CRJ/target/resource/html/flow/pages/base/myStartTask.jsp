...
<html>
  <head>
	...
	<%@include file="../../../pages/common/includeBase.jsp" %>
  </head>
  <body>
	<section class="panel">
        <div class="panel-body">
		        ...
		        <div class="panel-body">
		        	<form class="form-inline" role="form">
		        		<div class="form-group tools">
			            	<a href="javascript:;" class="fa fa-search yc_seach" table="flowexample" >查询</a>
			            </div>
	        ...
	        <div class="adv-table">
	        	<table id="flowexample" class="display tablehover table table-bordered dataTable" cellspacing="0" width="100%">
			        <thead>
			            <tr>
			            	<th></th>
			             	<th></th>
   	...
   	<script type="text/javascript" src="/html/flow/js/base/myStartTask.js" ></script>
  </body>
</html>
