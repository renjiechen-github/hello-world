...
<body>
	...
	<script type="text/javascript" src="/html/pages/flow/js/order/miLeaseorder/stepDetail8.js"></script> </c:if>
	...
	<script type="text/javascript" src="/html/pages/flow/js/order/leaseorder/stepDetail8.js"></script> </c:if>
</body>
</html>
