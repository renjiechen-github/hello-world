  	...
  	<c:choose>
	    ...
	    <div class="weui_cells">
				...
				<div class="upload">
					...
					<ul class="ipost-list ui-sortable js_fileList" id="fileurl6"></ul>
					<input type="hidden" value="${flowDetaiMap.orderList[0].picurls}" id="hideurl6" /> 
					<input type="hidden" value="0" name="picSize6" id="picSize6" />
					 <input type="hidden" value="" name="picPath6" id="picPath6" />
				</div>
				</div>
					 <div class="weui_cells">
				<div class="weui_cell">
				...
				<script type="text/javascript" src="/html/pages/flow/js/order/miAdmission/stepDetail.js" ></script>
  			<c:choose>
		    	...
		    	<c:when test="${cfg_step_id == '3'}">
		    		<jsp:include page="/html/pages/flow/pages/order/admission/stepDetail3.jsp"></jsp:include>
		    	</c:when>
	    ...
	    <div class="weui_cells">
				...
				<div class="upload">
					...
					<input type="hidden" value="0" name="picSize" id="picSize" />
  	...
  	<c:choose>
  		<c:when test="${edit==1}">
  			<form class="form-horizontal" id="form2">
				...
				<script type="text/javascript" src="/html/pages/flow/js/order/admission/stepDetail.js" ></script>
  			<c:choose>
		    	<c:when test="${cfg_step_id == '2'}">
		    		<jsp:include page="/html/pages/flow/pages/order/admission/stepDetail2.jsp"></jsp:include>
		    	</c:when>
		    	<c:when test="${cfg_step_id == '3'}">
		    		<jsp:include page="/html/pages/flow/pages/order/admission/stepDetail3.jsp"></jsp:include>
		    	</c:when>
		    	<c:when test="${cfg_step_id == '4'}">
		    		<jsp:include page="/html/pages/flow/pages/order/admission/stepDetail4.jsp"></jsp:include>
		    	</c:when>
		    	<c:when test="${cfg_step_id == '5'}">
		    		<jsp:include page="/html/pages/flow/pages/order/admission/stepDetail5.jsp"></jsp:include>
		    	</c:when>
