...
<c:if test="${isMobile eq '1'}">
			...
			<div class="panel-body">
				<div id="changeDiv">
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-8">
							<textarea rows="6" maxlength="256" id="flowremark" class="form-control"></textarea>
						</div>
						<div class="col-sm-2"></div>
					</div>
					<div class="weui_cells" id="pichides">
						<div class="upload">
	        		<div class="weui_cell file" id="selectImage1" onclick="stepDetail5.selectImages('fileUrl3');return false;">
	        			<a href="">选择文件上传</a> 
	        		</div>
	        		...
	        		<input type="hidden" value="0" name="picSize3" id="picSize3" /> 
				...
				<div id="changeDiv2">
					...
					<div class="form-group col-sm-12">
					  ...
					  <div class="weui_cells" id="pic1hide">
				<div class="upload">
	        		<div class="weui_cell file" id="selectImage" onclick="stepDetail5.selectImages('fileUrl5');return false;">
	        			<a href="">选择文件上传</a> 
	        		</div>
	        		<ul class="ipost-list ui-sortable js_fileList" id="fileUrl5" ></ul> 
	        	    <input type="hidden" value="${flowDetaiMap.orderList[0].picurls}"  id="hideurl5"  /> 	        	
		...
		<script type="text/javascript" src="/html/pages/flow/js/order/miWorkorder/stepDetail4.js"></script>
	</c:if>
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<div id="changeDiv2">
				<div class="form-group ">
					<label class="col-sm-2  control-label">受理人员：</label>
					<div class="col-sm-4">
						<select class="form-control" id="account" dataType="Require" msg="不得为空"></select>
					</div>
					<div class="col-sm-6"></div>
				</div>
			...
			<div class="form-group col-sm-12" id="changeDiv3" style="text-align: center;">
				...
				<button class="btn btn-info" onclick="stepDetail5.save(9);" type="button">回访跟进</button>
			</div>
		...
		<script type="text/javascript" src="/html/js/order_flow/utils/getManger.js" ></script>
	<script type="text/javascript" src="/html/pages/flow/js/order/workorder/stepDetail4.js"></script>
	</c:if>
</body>
</html>
