	...
	<div class="panel-body">
		<div class="panel-body">
			<form class="form-horizontal adminex-form" role="form">
				...
				<div id="showimagesdiv" class="form-group col-md-12 col-xs-12">
					<label class="col-md-2 col-xs-12 control-label">图片: </label>
					<!--<label class="col-md-2 col-xs-12 control-label">上传图片: </label>-->
					<div class="col-md-10 col-xs-12">
					<c:choose>
                    <c:when test="${isMobile eq 'Y'}">
                      <!--<div class="upload">-->
                        <!--<a href="javascript:;" class="file" id="myAwesomeDropzone" onclick="jsLivingProblemOrderDetail.uploadNbrAttachment()"> 选择照片上传 </a>-->
			...
			<div class="panel-body">
				<div class="custom-tab turquoise-tab col-md-12 col-xs-12">
					<ul class="nav nav-tabs js-tab" role="tablist">
						...
						<li role="presentation" class="col-md-2 col-xs-6"><a href="#BUTLER_TAKE_ORDER" class="text-center" aria-controls="BUTLER_TAKE_ORDER" role="tab" data-toggle="tab"> 接单 </a></li>
						<li role="presentation" class="col-md-2 col-xs-6"><a href="#BUTLER_EXECUTE" class="text-center" aria-controls="BUTLER_EXECUTE" role="tab" data-toggle="tab"> 执行 </a></li>
		...
		<div class="tab-content">
					...
					<div class="panel-body">
						<form class="form-horizontal adminex-form" role="form" id="takOrderForm">
							...
							<div class="text-center">
								<button class="btn btn-info hidden" id="confirmReassignOrderBtn" onclick="jsLivingProblemOrderDetail.assignOrder();" type="button">指派</button>
							</div>
						</form>
					</div>
				</div>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<form class="form-horizontal adminex-form" role="form" id="butlerGetHomeForm">
							...
							<div class="text-center">
							    <button class="btn btn-info hidden" id="butlerGetHomeBtn" onclick="jsLivingProblemOrderDetail.takeOrder()" type="button">接单</button>
							    <button class="btn btn-info hidden" id="rework"  onclick="jsLivingProblemOrderDetail.rework()" type="button">重新指派</button>
							    <button class="btn btn-info hidden" id="reassignOrder" onclick="jsLivingProblemOrderDetail.assignOrder1()" type="button">指派</button>
							    <button class="btn btn-info hidden" id="reback" onclick="jsLivingProblemOrderDetail.reback()" type="button">返回</button>
							
								<!-- <button class="btn btn-info hidden" id="butlerGetHomeBtn" onclick="jsLivingProblemOrderDetail.takeOrder()" type="button">保存</button> -->
							</div>
			...
			<div class="tab-pane fade" id="BUTLER_EXECUTE">
				<div class="panel panel-default">
                    ...
                    <c:when test="${isMobile eq 'Y'}">
                      <div class="upload">
                        <a href="javascript:;" class="file" id="upurl" onclick="jsLivingProblemOrderDetail.uploadhousePicture()"> 选择照片上传 </a>
            ...
            <div class="text-center">
            <button id="rentalAccountBtn" class="btn btn-info hidden" onclick="jsLivingProblemOrderDetail.processOrder('N');" type="button">保存</button>
            <button id="rentalAccountPassBtn" class="btn btn-info hidden" onclick="jsLivingProblemOrderDetail.processOrder('Y');" type="button">提交</button>
            </div>					
					</form>
					</div>
				</div>
...
<%-- 			<div class="tab-pane fade" id="CUSTOMER_SERV_VISIT">
              ...
              <div class="form-group col-md-12 col-xs-12">
                    ...
                    <c:when test="${isMobile eq 'Y'}">
                      <div class="upload">
                        <a href="javascript:;" class="file" id="js-visit-upurl" onclick="jsLivingProblemOrderDetail.uploadReback()"> 选择照片上传 </a>
					...
					<div class="row"></div>
						...
						<div class="col-md-2"></div>
							...
							<div class="text-center">
								<button class="btn btn-info hidden" id="marketingExecutiveAuditPassBtn" onclick="jsLivingProblemOrderDetail.marketingExecutiveAuditPass()" type="button">通过</button>
								<button class="btn btn-info hidden" id="rentalAccountReturn" onclick="jsLivingProblemOrderDetail.rentalAccountReturn()" type="button">客服追踪</button>
								<button class="btn btn-info hidden" id="confirmReassignOrderBtn1" onclick="jsLivingProblemOrderDetail.assignOrder2();" type="button">指派</button>
								<button class="btn btn-info hidden" id="reassignOrderBtn" onclick="jsLivingProblemOrderDetail.reassignOrderInStaffReview();" type="button">重新派单</button>
								<button class="btn btn-info hidden" id="cancelReassignOrderBtn" onclick="jsLivingProblemOrderDetail.cancelReassignOrder();" type="button">返回</button>
							</div>
						</form>
					</div>
				</div>
...
<script type="text/javascript" src="/html/pages/flow/js/order/leaseorder/livingProblemOrderDetail.js"></script>
</html>
