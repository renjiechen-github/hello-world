 ...
 * @since v1.0
 */
@Component("ManagerAuditNode")
public class ManagerAuditNode implements IProcessAction {
    ...
    private void doProcess(Map<String, Object> variables) {
        ...
        IManagerAuditNodeProcess process = SubOrderNodeFactory.getManagerAuditNode(workOrderDto.getType());
