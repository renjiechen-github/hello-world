...
<body>
	     	...
	     	<div class="weui_cell">
				...
				<div class="weui_cells" style="border-bottom: none;">
					<div class="weui_cell">
						...
						<div class="weui_cell_ft" id="remark">
							${map.taskdetail.remark}</div>
					</div>
				</div>
				<div class="division">
					<div class="left">
					...
					<c:if test="${not empty map.taskdetail.html_path }">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<jsp:include
									page="/flow/showTaskDetail.do?task_id=${map.taskdetail.task_id}&task_cfg_id=${map.taskdetail.task_cfg_id}&step_id=${map.stepMap.step_id}&cfg_step_id=${map.stepMap.cfg_step_id}"></jsp:include>
							</div>
						</div>
					</c:if>
				</div>
												...
												<c:forTokens items="${map1.file}" delims="," var="map2">
													<c:choose>
														<c:when test="${fn:split(map2, '##')[2] == '1'}">
															<!-- 图片展示 -->
															<a target="_blank"
																href="${task_path}${fn:split(map2, '##')[0]}"> <img
																alt="" title="${fn:split(map2, '##')[1]}"
																src="${task_path}${task_path}${fn:split(map2, '##')[0]}">
															</a>
														</c:when>
														<c:otherwise>
															<br />
	...
	<c:if test="${isMobile eq '0'}">
		...
		<ul class="nav nav-tabs" role="tablist" id="myTabs">
			<li role="presentation" class="active"><a href="#NEW_ORDER_2_DEAL" aria-controls="NEW_ORDER_2_DEAL" role="tab" data-toggle="tab">新我发起的任务</a></li>
			<li role="presentation"><a href="#OTHER_2_DEAL" aria-controls="OTHER_2_DEAL" role="tab" data-toggle="tab">普通我发起的任务</a></li>
		</ul>
		</header>
		...
		<div id="myTabContent" class="tab-content">
			...
			<div class="tab-pane fade" id="OTHER_2_DEAL">
					...
					<div class="panel-body">
						<form class="form-inline" role="form">
							<div class="form-group">
								<label for="exampleInputEmail2">发起任务时间:</label> <input
									type="text" style="width: 275px" name="sendTime"
									readonly="readonly" id="sendTime" class="form-control"
									placeholder="2013-01-02 01:00 至 2013-01-02 01:10" class="span4" />
							</div>
							<div class="form-group flowtypediv ">
								<label class="" for="exampleInputEmail2">任务类型:</label> <select
									class="form-control" t="type" id="flowType0" name="flowType0">
							...
							<div class="form-group">
								<label class="" for="exampleInputEmail2">任务状态:</label> <select
									class="form-control" id="secondary_type" name="secondary_type">
									<option value="">请选择...</option>
							...
							<div class="form-group">
								<label class="" for="exampleInputEmail2">任务名称:</label> <input
									type="text" class="form-control" id="taskName" name="taskName"
									placeholder="模糊查询任务名称">
							</div>
							<div class="form-group">
								<label class="" for="exampleInputEmail2">任务编号:</label> <input
									type="text" class="form-control" id="taskCode" name="taskCode"
									placeholder="模糊查询任务编号">
							</div>
							<div class="form-group tools">
								<a href="javascript:;" class="fa fa-search yc_seach"
									table="flowexample">查询</a>
							</div>
				...
				<div class="tab-pane fade in active" id="NEW_ORDER_2_DEAL">
					...
					<div class="panel-body">
						<form class="form-inline" role="form">
							<div class="form-group">
								<label for="exampleInputEmail2">订单类型:</label> <select
									class="form-control" id="order_type" name="order_type">
									<option value="">请选择...</option>
								</select>
							</div>
							<div class="form-group">
								<label for="exampleInputEmail2">订单状态:</label> <select
									class="form-control" id="order_state" name="order_state">
									<option value="">请选择...</option>
							...
							<!-- <div class="form-group">
							<label for="exampleInputEmail2">用户名:</label> <input type="text" class="form-control" id="user_name" name="user_name" placeholder="请填写用户名">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail2">手机号:</label> <input type="text" class="form-control" id="user_mobile" name="user_mobile" placeholder="请填写用户手机">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail2">订单编号:</label> <input type="text" class="form-control" id="order_code" name="user_mobile" placeholder="请填写订单编号">
						</div> -->
							<div class="form-group">
								<label for="exampleInputEmail2">模糊查询:</label> <input type="text"
									class="form-control suitable" id="keyword" placeholder="用户名、用户手机、订单编号">
							</div>
							<span class="form-group tools"><a href="javascript:;"
								class="fa fa-search yc_seach" id="searchOrder"
								table="workOrderTable">查询</a> </span>
						</form>
					</div>
					</section>
					<div class="adv-table">
			...
			<script type="text/javascript"
				src="/html/pages/flow/js/base/myStartOrder.js"></script>
			<script type="text/javascript"
				src="/html/pages/flow/js/base/myStartTask.js"></script>
	</c:if>
</body>
</html>
