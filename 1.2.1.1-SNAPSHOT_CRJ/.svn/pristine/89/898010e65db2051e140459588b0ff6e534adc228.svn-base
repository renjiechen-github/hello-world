...
/**
 *
 * Description: routine_cleaning_order_value_his 实体
 *
 ...
 * @since v1.0
 */
@Table(name = "routine_cleaning_order_value_his")
public class RoutineCleaningOrderValueHisDto implements Serializable {
    /**
     * 主键
     * @mbg.generated
     */
