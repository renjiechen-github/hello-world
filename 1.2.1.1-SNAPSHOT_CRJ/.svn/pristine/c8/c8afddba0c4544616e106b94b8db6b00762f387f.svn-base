 ...
 * @since v1.0
 */
@Component("RentalAccountNode")
public class RentalAccountNode implements IProcessAction {
    ...
    private void doProcess(Map<String, Object> variables) {
        ...
        IRentalAccountNodeProcess process = SubOrderNodeFactory.getRentalAccountNode(workOrderDto.getType());
