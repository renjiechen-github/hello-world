...
<body>
    ...
    <!-- 各个TAB页内容 -->
		<div class="tab-content">
					...
					<div class="panel-body">
						<form class="form-horizontal adminex-form" role="form" id="takOrderForm">
							...
							<div class="text-center">
								<button class="btn btn-info hidden" id="confirmReassignOrderBtn" onclick="jsComplaintOrderDetail.assignOrder();" type="button">指派</button>
							</div>
						</form>
					</div>
				</div>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<form class="form-horizontal adminex-form" role="form" id="butlerGetHomeForm">
							...
							<div class="text-center">
							    <button class="btn btn-info hidden" id="butlerGetHomeBtn" onclick="jsComplaintOrderDetail.takeOrder()" type="button">接单</button>
							    <button class="btn btn-info hidden" id="rework"  onclick="jsComplaintOrderDetail.rework()" type="button">重新指派</button>
							    <button class="btn btn-info hidden" id="reassignOrder" onclick="jsComplaintOrderDetail.assignOrder1()" type="button">指派</button>
							    <button class="btn btn-info hidden" id="reback" onclick="jsComplaintOrderDetail.reback()" type="button">返回</button>
							
								<!-- <button class="btn btn-info hidden" id="butlerGetHomeBtn" onclick="jsComplaintOrderDetail.takeOrder()" type="button">保存</button> -->
							</div>
            ...
            <div class="text-center">
              <button id="rentalAccountBtn" class="btn btn-info hidden" onclick="jsComplaintOrderDetail.processOrder('N');" type="button">保存</button>
              <button id="rentalAccountPassBtn" class="btn btn-info hidden" onclick="jsComplaintOrderDetail.processOrder('Y');" type="button">提交</button>
            </div>					
					</form>
					</div>
				</div>
...
<!-- 			<div class="tab-pane fade" id="CUSTOMER_SERV_VISIT">
              ...
              <div class="hidden form-group col-md-12 col-xs-12 js-reassign-manager-div1">
                ...
                <div class="col-md-6 col-xs-12"></div>
							...
							<div class="text-center">
								<button class="btn btn-info hidden" id="marketingExecutiveAuditPassBtn" onclick="jsComplaintOrderDetail.marketingExecutiveAuditPass()" type="button">通过</button>
								<button class="btn btn-info hidden" id="rentalAccountReturn" onclick="jsComplaintOrderDetail.rentalAccountReturn()" type="button">客服跟踪</button>
								<button class="btn btn-info hidden" id="confirmReassignOrderBtn1" onclick="jsComplaintOrderDetail.assignOrder2();" type="button">指派</button>
								<button class="btn btn-info hidden" id="reassignOrderBtn" onclick="jsComplaintOrderDetail.reassignOrderInStaffReview();" type="button">重新派单</button>
								<button class="btn btn-info hidden" id="cancelReassignOrderBtn" onclick="jsComplaintOrderDetail.cancelReassignOrder();" type="button">返回</button>
							</div>
						</form>
					</div>
				</div>
...
<script type="text/javascript" src="/html/pages/flow/js/order/leaseorder/complaintOrderDetail.js"></script>
