...
/**
 *
 * Description: agent_apply_order_value 实体
 *
 ...
 * @since v1.0
 */
@Table(name = "agent_apply_order_value")
public class AgentApplyOrderValueDto extends SubOrderValueDto implements Serializable {
    /**
     * 主键
     * @mbg.generated
     */
    ...
    public String toString() {
        ...
        builder.append("AgentApplyOrderValueDto [id=");
        builder.append(id);
