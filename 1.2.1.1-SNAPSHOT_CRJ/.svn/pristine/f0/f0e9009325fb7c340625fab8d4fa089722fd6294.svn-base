 ...
 * @since v1.0
 */
@Component("Wait2PayNode")
public class Wait2PayNode implements IProcessAction {
    ...
    private void doProcess(Map<String, Object> variables) {
        ...
        IWait2PayNodeProcess process = SubOrderNodeFactory.getWait2PayNode(workOrderDto.getType());
