 ...
 * @since v1.0
 */
@Component("FinanceAuditNode")
public class FinanceAuditNode implements IProcessAction {
    ...
    private void doProcess(Map<String, Object> variables) {
        ...
        IFinanceAuditNodeProcess process = SubOrderNodeFactory.getFinanceAuditNode(workOrderDto.getType());
