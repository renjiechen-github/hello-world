	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<div class="form-group col-sm-12" id="changeDiv3" style="text-align: center;">
				...
				<button class="btn btn-info" onclick="stepDetail6.save(2);" type="button">关闭订单</button>
			</div>
			<div class="form-group col-sm-12" id="changeDiv4"
				style="text-align: center;">
				<button class="btn btn-info" id="back" type="button">返回</button>
				<button class="btn btn-info" onclick="stepDetail6.save(3);" type="button">指派</button>
			</div>
		</div>
	</div>
	</section>
	<script type="text/javascript" src="/html/pages/flow/js/order/otherorder/stepDetail5.js"></script>
</body>
</html>
