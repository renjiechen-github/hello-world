...
/**
 *
 * Description: owner_repair_order_his实体
 *
 ...
 * @since v1.0
 */
public class OwnerRepairOrderHisDto implements Serializable {
    /**
     * priority 优先级
     */
    ...
    public String toString() {
        ...
        builder.append("OwnerRepairOrderHisDto [priority=");
        ...
        builder.append(comments);
        builder.append(", takeHouseOrderName=");
        builder.append(takeHouseOrderName);
