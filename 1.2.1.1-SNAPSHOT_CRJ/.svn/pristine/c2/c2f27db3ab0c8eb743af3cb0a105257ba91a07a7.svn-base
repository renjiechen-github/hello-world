 ...
 * @since v1.0
 */
@Component(value = "OwnerCancelLeaseOrderCheckNeedReGetHomeInRentalAudit")
public class CheckNeedReGetHomeInRentalAudit implements IProcessExpression {
    ...
    public boolean getResult(Map<String, Object> variables) {
        ...
        ownerCancelLeaseOrderValueDto.setAttrPath("OCL_ORDER_PROCESS.RENTAL_ACCOUNT.PASSED");
