...
/**
 *
 * Description: owner_repair_order_value实体
 *
 ...
 * @since v1.0
 */
public class OwnerRepairOrderValueDto extends SubOrderValueDto implements Serializable {
    /**
     * id 主键
     */
    private Long id;
    ...
    public String toString() {
        ...
        builder.append("OwnerRepairOrderValueDto [id=");
        builder.append(id);
