...
/**
 *
 * Description: owner_cancel_lease_order_value_his 实体
 *
 ...
 * @since v1.0
 */
@Table(name = "owner_cancel_lease_order_value_his")
public class OwnerCancelLeaseOrderValueHisDto implements Serializable {
    /**
     * 优先级
     * @mbg.generated
     */
