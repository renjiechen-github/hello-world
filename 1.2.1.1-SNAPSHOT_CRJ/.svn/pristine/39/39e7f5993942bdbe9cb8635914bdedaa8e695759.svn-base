 ...
 * date: 2017年7月5日
 */
package com.yc.rm.caas.appserver.base.privilege.controller;
...
import com.yc.rm.caas.appserver.base.privilege.controller.fo.*;
import com.yc.rm.caas.appserver.base.privilege.entity.*;
import com.yc.rm.caas.appserver.model.privilege.PublicRoleBean;
import com.yc.rm.caas.appserver.model.team.TeamBean;
import com.yc.rm.caas.appserver.base.privilege.service.IPrivilegeServ;
...
/*	@RequestMapping("/reloadRoles")
	...
	Object modifyRole(@RequestBody Role role) {
		...
		if (role.getName() != null && !(role.getName().equals(""))) {
			role.setName(EmojiParser.parseToAliases(role.getName()));
		}
