...
/**
 *
 * Description: living_problem_order_value_his 实体
 *
 ...
 * @since v1.0
 */
@Table(name = "living_problem_order_value_his")
public class LivingProblemOrderValueHisDto implements Serializable {
    /**
     * 主键
     * @mbg.generated
     */
