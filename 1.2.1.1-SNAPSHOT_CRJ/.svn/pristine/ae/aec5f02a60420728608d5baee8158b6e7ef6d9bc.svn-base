...
/**
 *
 * Description: cleaning_order_his实体
 *
 ...
 * @since v1.0
 */
public class CleaningOrderHisDto implements Serializable {
    /**
     * priority 优先级
     */
     ...
     * subOrderValueList
     */
    private List<CleaningOrderValueHisDto> subOrderValueList;
    ...
    public List<CleaningOrderValueHisDto> getSubOrderValueList() {
        return subOrderValueList;
    }

    public void setSubOrderValueList(List<CleaningOrderValueHisDto> subOrderValueList) {
    ...
    public String toString() {
        ...
        builder.append("CleaningOrderHisDto [priority=");
