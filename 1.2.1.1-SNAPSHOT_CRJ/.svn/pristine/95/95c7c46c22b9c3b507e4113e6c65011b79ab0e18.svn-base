...
public class ConvertNum
{
	...
	public static String NumToChinese(String number)
	{
		...
		if (num > 99999999999999.99 || num < -99999999999999.99) throw new IllegalArgumentException(
		...
		for (int i = 0; i < numParts; i++)
		{
			...
			if (i % 2 == 0)
			{
				if ("".equals(partChinese)) beforeWanIsZero = true;
				else
		...
		{
			if (numJiao == 0) chineseStr = chineseStr + "零" + ChineseNum[numFen] + "分";
			else
