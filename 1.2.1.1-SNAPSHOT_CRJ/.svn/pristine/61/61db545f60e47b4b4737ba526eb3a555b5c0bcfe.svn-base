...
public class FormatTag extends BodyTagSupport {
	public static final Logger logger = org.slf4j.LoggerFactory.getLogger(FormatTag.class);
	...
	public static void main(String[] args) throws ParseException {
		logger.debug(String.format("%1$tY-%1$tm-%1$td %1$tH:%1$tM:%1$tS", dateFormatD.parse("2009-01-02")));
	}
