...
/**
 *
 * Description: agent_apply_order 实体
 *
 ...
 * @since v1.0
 */
@Table(name = "agent_apply_order")
public class AgentApplyOrderDto implements Serializable {
    /**
     * 主键
     * @mbg.generated
     */
    ...
    public String toString() {
        ...
        builder.append("AgentApplyOrderDto [id=");
        builder.append(id);
        builder.append(", code=");
        builder.append(code);
