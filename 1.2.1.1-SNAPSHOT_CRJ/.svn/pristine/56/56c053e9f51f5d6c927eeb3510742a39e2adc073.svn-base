...
public class TeamRelFo
{
	...
	{
		return "TeamRelFo [userId=" + userId + ", teamId=" + teamId + ", memberId=" + memberId + ", topTeamId=" + topTeamId + ", ifCharge=" + ifCharge + ", areaIdList=" + areaIdList
				+ ", removeAreaList=" + removeAreaList + ", memberList=" + memberList + ", removeMemberList=" + removeMemberList + "]";
	}
