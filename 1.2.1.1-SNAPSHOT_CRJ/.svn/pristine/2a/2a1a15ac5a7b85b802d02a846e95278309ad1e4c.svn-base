 ...
 * @since v1.0
 */
@Component("DoingInOrderNode")
public class DoingInOrderNode implements IProcessAction {
    ...
    private void doProcess(Map<String, Object> variables) {
        ...
        IDoingInOrderNodeProcess process = SubOrderNodeFactory.getDoInOrderNode(workOrderDto.getType());
