	    ...
	    <div class="weui_cells">
  			...
  			<c:choose>
		    	<c:when test="${cfg_step_id == '2'}">
		    		<jsp:include page="/html/pages/flow/pages/order/rankorder/stepDetail2.jsp"></jsp:include>
		    	</c:when>
		    	...
		    	<c:when test="${cfg_step_id == '4'}">
		    		<jsp:include page="/html/pages/flow/pages/order/rankorder/stepDetail4.jsp"></jsp:include>
		    	</c:when>
		    ...
		    <script type="text/javascript" src="/client/js/jquery-1.10.2.js"></script>
                ...
                <script type="text/javascript" src=" /html/pages/flow/js/order/miRankorder/stepDetail.js"></script>
  		</c:when>
