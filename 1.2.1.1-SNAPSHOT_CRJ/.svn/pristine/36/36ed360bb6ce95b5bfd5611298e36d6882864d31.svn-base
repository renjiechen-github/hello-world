...
<section class="panel">
	...
	<script type="text/javascript" src="/html/pages/flow/js/order/miOtherorder/stepDetail2.js"></script>
</c:if>
<c:if test="${isMobile eq '0'}">
	...
	<script type="text/javascript" src="/html/pages/flow/js/order/otherorder/stepDetail2.js"></script>
	</c:if>
</body>
</html>
