 ...
 * @since v1.0
 */
@Component("TakeOrderNode")
public class TakeOrderNode implements IProcessAction {
    ...
    private void doProcess(Map<String, Object> variables) {
        ...
        ITakeOrderNodeProcess process = SubOrderNodeFactory.getTakeOrderNode(workOrderDto.getType());
